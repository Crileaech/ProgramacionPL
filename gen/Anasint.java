...
public class Anasint extends Parser {
	...
	public static class ElementalesContext extends ParserRuleContext {
		...
		public ElementalesContext() { }
		public void copyFrom(ElementalesContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class DecVarElemContext extends ElementalesContext {
		...
		public DecVarElemContext(ElementalesContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AnasintListener ) ((AnasintListener)listener).enterDecVarElem(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AnasintListener ) ((AnasintListener)listener).exitDecVarElem(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AnasintVisitor ) return ((AnasintVisitor<? extends T>)visitor).visitDecVarElem(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ElementalesContext elementales() throws RecognitionException {
		...
		try {
			int _alt;
			_localctx = new DecVarElemContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(108);
			_errHandler.sync(this);
	...
	public static class SecuenciasContext extends ParserRuleContext {
		...
		public SecuenciasContext() { }
		public void copyFrom(SecuenciasContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class DecVarSeqContext extends SecuenciasContext {
		...
		public DecVarSeqContext(SecuenciasContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AnasintListener ) ((AnasintListener)listener).enterDecVarSeq(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AnasintListener ) ((AnasintListener)listener).exitDecVarSeq(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AnasintVisitor ) return ((AnasintVisitor<? extends T>)visitor).visitDecVarSeq(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final SecuenciasContext secuencias() throws RecognitionException {
		...
		try {
			_localctx = new DecVarSeqContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(115);
			match(VAR);
	...
	public static final String _serializedATN =
		...
		"\u00e0\t\6\2\2\u00e0\u00e5\5&\24\13\u00e1\u00e2\f\b\2\2\u00e2\u00e3\t"+
		"\5\2\2\u00e3\u00e5\5&\24\t\u00e4\u00de\3\2\2\2\u00e4\u00e1\3\2\2\2\u00e5"+
