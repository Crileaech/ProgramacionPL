...
public interface AnasintListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code parentesisInteger}
	 * labeled alternative in {@link Anasint#expr_integer}.
	 * @param ctx the parse tree
	 */
	void enterParentesisInteger(Anasint.ParentesisIntegerContext ctx);
	/**
	 * Exit a parse tree produced by the {@code parentesisInteger}
	 * labeled alternative in {@link Anasint#expr_integer}.
	 * @param ctx the parse tree
	 */
	void exitParentesisInteger(Anasint.ParentesisIntegerContext ctx);
	/**
